    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-[#F8F7F4]">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white hover:bg-gray-50 active:scale-[0.98] border border-gray-200 text-gray-700 font-semibold py-3.5 rounded-xl text-base transition-all disabled:opacity-60 flex items-center justify-center gap-3 shadow-sm"
        >
          {loading ? (
            <span className="text-gray-400">Redirecting to Google...</span>
          ) : (
            <>
              {/* Google logo SVG */}
