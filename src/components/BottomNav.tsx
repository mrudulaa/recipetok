...
const ImportIcon = ({ active }: { active: boolean }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? "#E8773A" : "rgba(245,237,214,0.35)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          return (
            <Link
              ...
              style={{
                ...
                background: active ? "rgba(232, 119, 58, 0.12)" : "transparent",
                textDecoration: "none",
                minWidth: "56px",
              }}
            >
              ...
              <span style={{
                ...
                color: active ? "#E8773A" : "rgba(245,237,214,0.35)",
